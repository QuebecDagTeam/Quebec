...
export const UserAuth: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-[#000306] font-inter">
 ...
 <div className="w-full h-4 bg-gray-200 max-w-4xl  rounded-full overflow-hidden mb-10">
          <div className="h-full bg-[#8C2A8F] transition-all duration-300" style={{ width: progressWidth }} />
        </div>
        </div>
        </> 
        }
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto space-y-8">
          ...
          {progress === 2 && (
            <div>
              <div className="py-5">
                ...
                <p className="text-white">Let’s verify it’s you, please position your head within the frame and hold still while we scan</p>
              </div>
              ...
              <div className="bg-[#2F2F2F] gap-8 w-1/3 px-[30px] py-[20px]  flex-col rounded-[8px] flex items-center justify-center ">
                <div className="bg-[#424242] w-[2/3] h-auto text-white p-5">
                  <p className="text-[18px]">Good Lightning</p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <button
              type="button"
              className="px-6 py-3 bg-[#BDBDBD] rounded-full text-black font-medium"
              disabled={progress === 1}
            ...
            <button
              type="button"
              className="px-6 py-3 bg-[#8C2A8F] rounded-full text-white font-medium"
              disabled={progress === 2}
          ...
          <button
            ...
            className={`mt-8 w-full sm:w-auto px-6 py-4 rounded-xl text-lg font-bold transition duration-300 
              ${loading || !address
